...
const FONT_AXIS  = '15px Noto Sans JP';
const FONT_SIZE = 20;
const ANGLE_FONT_AXIS  = '30px Noto Sans JP';
const ANGLE_FONT_SIZE = 60;
...
function drawProtractor(ctx, centerX, centerY, radius) 
{
    ...
    const majorTickLength = 45;
    const minorTickLength = 15;

    ctx.strokeStyle = COLOR_BLACK;
    ctx.fillStyle = COLOR_BLACK;
    ctx.font = ANGLE_FONT_AXIS;
...
function drawAngle(canvas, ctx, angle)
{
    ...
    ctx.font = `${ANGLE_FONT_SIZE}px 'Courier New', monospace`;
    ctx.textAlign = "center";
    ctx.textBaseline = "middle";
    ctx.lineWidth = 1.5;
